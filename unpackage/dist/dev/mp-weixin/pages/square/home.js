...
var _default = { name: 'square', data: function data() {return { token: uni.getStorageSync('id_token'), activityData: [], cardCur: 0, adCardCur: 0, swiperList: [{ id: 0, type: 'image', url: 'https://s1.ax1x.com/2020/05/24/Yztohd.jpg' }, { id: 1, type: 'image', url: 'https://s1.ax1x.com/2020/05/24/Yzt5Ae.jpg' }, { id: 2, type: 'image', url: 'https://s1.ax1x.com/2020/05/23/Yxngvd.jpg' }, { id: 3, type: 'image', url: 'https://s1.ax1x.com/2020/05/23/YvVQ4H.jpg' }, { id: 4, type: 'image', url: 'https://bkimg.cdn.bcebos.com/pic/023b5bb5c9ea15ce36d3e190bd492df33a87e950145b?x-bce-process=image/watermark,g_7,image_d2F0ZXIvYmFpa2U5Mg==,xp_5,yp_5' }], adSwiperList: [// 直播
      ...
      // 	});
      // }
    }, viewSubMenu: function viewSubMenu(index) {console.log(index);if (index === 0) {uni.navigateTo({ url: '/pages/policy/index?articleType=0' });}if (index === 1) {uni.navigateTo({ url: '/pages/topic/home' });}if (index === 2) {
        uni.navigateTo({
